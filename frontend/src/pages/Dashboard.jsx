        ...
        {allResumes.map((resume,index)=>{
          ...
          return(
            ...
            <p className='text-sm group-hover:scale-105 transition-all px-2 text-center' style={{color:baseColor}}>{resume.title}</p>
              <p className='absolute bottom-1 text-[11px] text-slate-400 group-hover:text-slate-500 transiton-all duration-300 px-2 text-center' style={{color:baseColor + '90'}}> 
